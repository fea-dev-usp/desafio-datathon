...
#Agora vamos plotar os gráficos das correlações gerais, ou seja, sem selecionar especificamente o período de crise
#como podemos ver pelos scatters, a correlação entre ambos os ativos é muito baixa
...
#comparando esses plots com os feitos anteriormente, não vemos nenhuma mudança significativa no 
#relacionamento das duas variáveis
